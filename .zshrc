...
# Add all the tools to the path co You can use them nicely :D have a nice day!
...
# In order to keep exports and constants in one place
if [ -f ~/.profile_exports ]; then
    . ~/.profile_exports
fi

# In order to work effortless
